...
![Bash](https://bashlogo.com/img/logo/png/full_colored_dark.png)
...
```console
wget https://github.com/raisty/linux-post-install/releases/latest/download/after-effects -O after-effects
wget https://github.com/raisty/linux-post-install/releases/latest/download/sha256sums.txt -O sha256sums.txt
...
Make all post-scripts executable.
...
| Tor                     | tor               | tor, tor-geoipdb, torsocks, deb.torproject.org-keyring       |
